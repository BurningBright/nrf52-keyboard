...
#define VENDOR_ID 0x1271 /* USB VID */
#define PRODUCT_ID 0x0512 /* USB PID */
#define CONF_VENDOR_ID 0x1271 /* 配置协议使用的VendorID */
#define CONF_PRODUCT_ID 0x0512 /* 配置协议使用的ProductID */
#define DEVICE_VER 0x0001 /* 硬件版本 */
#define MANUFACTURER "BurningBright" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "ERGO88-R" /* 硬件名称，用于USB和蓝牙显示 */
...
#define UART_RXD 5 // UART_RX口IO
#define UART_TXD 6 // UART_TX口IO
...
// 充电检测配置
#define PIN_CHARGING !P3_4 // CH554的充电检测。当UCC1拉低时表示正在充电
#define PIN_STANDBY !P3_3 // CH554的充电检测。当UCC2拉低时表示充电完成。若不配置则只使用PIN_CHARGING作为是否充电的检测标志

// 按键阵列配置
static const uint8_t row_pin_array[MATRIX_ROWS] = { 20, 16, 7, 10, 9, 8 };
static const uint8_t column_pin_array[MATRIX_COLS] = { 11, 12, 13, 14, 15, 17, 18, 19 };

#define ROW_IN // 键盘阵列的二极管方向是从COL->ROW

#define NRF_BL_DFU_ENTER_METHOD_PINRESET 4
