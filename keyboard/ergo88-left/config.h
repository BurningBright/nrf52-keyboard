...
// 按键阵列配置
static const uint8_t row_pin_array[MATRIX_ROWS] = { 21, 25, 8, 2, 4, 3 };
static const uint8_t column_pin_array[MATRIX_COLS] = { 22, 23, 24, 28, 29, 30, 26, 27 };

#define ROW_IN // 键盘阵列的二极管方向是从COL->ROW

#define NRF_BL_DFU_ENTER_METHOD_PINRESET 20
